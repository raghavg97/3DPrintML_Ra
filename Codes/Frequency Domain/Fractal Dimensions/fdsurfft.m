...
figure;
p = polarplot(pi/NUM_DIR + (ang - 1)* 2 * pi/ NUM_DIR - 0.1309 , (6+slope(ang))/2, '-','LineWidth',3);rlim([0 3]);ax =gca;ax.FontSize = 14; ax.RTick = [0 0.5 1 1.5 2 2.5 3]; p.Marker = 'square';     
